...
// аргументы и возвращать результат, она не влияет на переменные вне ее и снаружи, на функцию ничто не может 
...
// в javascript существуют еще чистые функции, чистая функция должна быть детерминированной,
