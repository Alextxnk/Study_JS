...
// model и year - это имена свойств, еще их называют ключи 
...
obj.color = 'black'; // в объект, созданный конструктором можно также добавлять свойства 
...
// массив в javascript - это объект в котором ключи заполняются javascript автоматически 
